...
cat > /scratch/project_462000964/members/wangchao/training/081225/eight_nodes_wrapper_script.sh << 'EOF'
#!/bin/bash
...
python mammoth/train.py \
    -config /scratch/project_462000964/members/wangchao/training/081225/eight_nodes.yaml \
    --node_rank ${SLURM_PROCID} \
    --master_ip ${MASTER_NODE} \
    --master_port ${MASTER_PORT} \
EOF

chmod +x /scratch/project_462000964/members/wangchao/training/081225/eight_nodes_wrapper_script.sh
...
/scratch/project_462000964/members/wangchao/training/081225/eight_nodes_wrapper_script.sh
