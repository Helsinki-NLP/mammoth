...
cat > /scratch/project_2005099/members/chaowang/training/four_nodes/multinode_train_script.sh << 'EOF'
#!/bin/bash
module purge
module load pytorch
...
chmod +x /scratch/project_2005099/members/chaowang/training/four_nodes/multinode_train_script.sh
...
srun /scratch/project_2005099/members/chaowang/training/four_nodes/multinode_train_script.sh
