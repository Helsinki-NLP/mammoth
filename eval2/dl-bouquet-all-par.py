...
# Purpose
# -------
# Prepare local paragraph-level BOUQuET benchmark files for the eval2 workflow.
#
...
# and split under:
#
#     data/bouquet_par/<split>/<language>.txt
#
# Current behavior
# ----------------
# The script:
