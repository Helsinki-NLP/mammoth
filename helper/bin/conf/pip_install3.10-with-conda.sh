...
echo This script is deprecated and incorrect
echo Please use pip_install3.10-with-site.sh instead.
exit 1
...
#   pip install x-transformers==1.32.14
    pip install --no-deps x-transformers==1.32.14  # cure of symptom; avoid torch install
#   it is better to use `pip_install3.10-with-site.sh`
