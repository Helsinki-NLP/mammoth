...
singularity exec \
    ...
    /appl/local/containers/sif-images/lumi-pytorch-rocm-6.2.4-python-3.12-pytorch-v2.7.1.sif \
    $your_path_in_lumi/.venv/bin/pip install -r $path_to_mammoth/requirements_lumi.txt
...
#     -B /scratch/project_462000964/members/wangchao:/scratch/project_462000964/members/wangchao:rw \
#     /appl/local/containers/sif-images/lumi-pytorch-rocm-6.2.4-python-3.12-pytorch-v2.7.1.sif \
#     /scratch/project_462000964/members/wangchao/.venv/bin/pip install -r /scratch/project_462000964/members/wangchao/mammoth/requirements_lumi.txt