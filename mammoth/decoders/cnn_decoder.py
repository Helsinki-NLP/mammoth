...
from mammoth.modules import ConvMultiStepAttention, GlobalAttention
from mammoth.utils.cnn_factory import shape_transform, GatedConv
...
class CNNDecoder(DecoderBase):
    ...
    def forward(self, tgt, memory_bank, step=None, **kwargs):
        """See :obj:`mammoth.modules.RNNDecoderBase.forward()`"""
