...
from mammoth.modules.sparse_activations import sparsemax
from mammoth.utils.misc import aeq, sequence_mask
...
class GlobalAttention(nn.Module):
    ...
    * Bahdanau Attention (mlp):
    ...
    def __init__(self, dim, coverage=False, attn_type="dot", attn_func="softmax"):
        ...
        self.dim = dim
        assert attn_type in ["dot", "general", "mlp"], "Please select a valid attention type (got {:s}).".format(
            attn_type
        )
