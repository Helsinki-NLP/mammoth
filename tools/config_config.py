...
def get_opts():
    ...
    parser_starting_step.add_argument('-in_config', required=True)
    parser_starting_step.add_argument('-out_config')
    parser_define_group = subparsers.add_subparser('define_group')
    parser_define_group.add_argument('-in_config', required=True)
    ...
    parser_allocate_devices.add_argument('-in_config', required=True)
    ...
    parser_adapter_config.add_argument('-in_config', required=True)
